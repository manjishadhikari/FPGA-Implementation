...
HD_PWD='H:/Xilinxprojects/project_uartcontrol/project_uartcontrol.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_loop.vds -m64 -mode batch -messageDb vivado.pb -notrace -source uart_loop.tcl
