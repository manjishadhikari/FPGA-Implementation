...
HD_PWD='H:/test/project_knightrider/project_knightrider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log knightrider.vdi -applog -m64 -messageDb vivado.pb -mode batch -source knightrider.tcl -notrace
