...
HD_PWD='H:/Xilinxprojects/project_uartcontrol/project_uartcontrol.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_loop.vdi -applog -m64 -messageDb vivado.pb -mode batch -source uart_loop.tcl -notrace
