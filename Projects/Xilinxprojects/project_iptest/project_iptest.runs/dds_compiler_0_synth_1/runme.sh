...
HD_PWD='H:/Xilinxprojects/project_iptest/project_iptest.runs/dds_compiler_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_compiler_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source dds_compiler_0.tcl
