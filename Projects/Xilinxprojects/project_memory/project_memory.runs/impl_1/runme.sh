...
HD_PWD='H:/Xilinxprojects/project_memory/project_memory.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log memory_01.vdi -applog -m64 -messageDb vivado.pb -mode batch -source memory_01.tcl -notrace
