...
HD_PWD='H:/Xilinxprojects/project_fourtapfirnew/project_fourtapfirnew.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log firfilter_4tap.vds -m64 -mode batch -messageDb vivado.pb -notrace -source firfilter_4tap.tcl
