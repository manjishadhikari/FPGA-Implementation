...
HD_PWD='H:/Xilinxprojects/project_linearinterpolation/project_linearinterpolation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log firfilter_5tap.vds -m64 -mode batch -messageDb vivado.pb -notrace -source firfilter_5tap.tcl
