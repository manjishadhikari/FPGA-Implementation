...
HD_PWD='H:/project_dft/project_dft.runs/bd_fc5c_0_ilmb_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_fc5c_0_ilmb_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source bd_fc5c_0_ilmb_0.tcl
