...
CONFIG.BOARD.ASSOCIATED_PARAM {UART_BOARD_INTERFACE} \
 ] $UART
...
CONFIG.use_bram_block.VALUE_SRC {DEFAULT} \
  ...
  set microblaze_I [ create_bd_cell -type ip -vlnv xilinx.com:ip:microblaze:9.6 microblaze_I ]
  set_property -dict [ list \
...
CONFIG.C_USE_REORDER_INSTR {0} \
  ...
  connect_bd_net -net LMB_Rst [get_bd_pins dlmb/SYS_Rst] [get_bd_pins ilmb/SYS_Rst] [get_bd_pins rst_0/bus_struct_reset]
  ...
  connect_bd_net -net dlmb_LMB_Rst [get_bd_pins dlmb/LMB_Rst] [get_bd_pins dlmb_cntlr/LMB_Rst]
  connect_bd_net -net ilmb_LMB_Rst [get_bd_pins ilmb/LMB_Rst] [get_bd_pins ilmb_cntlr/LMB_Rst]
