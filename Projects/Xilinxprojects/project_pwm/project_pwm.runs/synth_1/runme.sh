...
HD_PWD='H:/Xilinxprojects/project_pwm/project_pwm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log question_5.vds -m64 -mode batch -messageDb vivado.pb -notrace -source question_5.tcl
