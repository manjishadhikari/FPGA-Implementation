...
HD_PWD='H:/Xilinxprojects/project_counterfinal/project_counterfinal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ratecounter_source.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ratecounter_source.tcl
