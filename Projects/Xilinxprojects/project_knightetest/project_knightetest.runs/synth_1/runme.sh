...
HD_PWD='H:/Xilinxprojects/project_knightetest/project_knightetest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log knight_rider.vds -m64 -mode batch -messageDb vivado.pb -notrace -source knight_rider.tcl
