...
HD_PWD='H:/Xilinxprojects/project_knightetest/project_knightetest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log knight_rider.vdi -applog -m64 -messageDb vivado.pb -mode batch -source knight_rider.tcl -notrace
