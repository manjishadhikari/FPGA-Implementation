...
HD_PWD='H:/Xilinxprojects/project_counterfinal/project_counterfinal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ratecounter_source.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ratecounter_source.tcl -notrace
