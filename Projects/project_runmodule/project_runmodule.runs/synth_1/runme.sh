...
HD_PWD='H:/project_runmodule/project_runmodule.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log runmodule.vds -m64 -mode batch -messageDb vivado.pb -notrace -source runmodule.tcl
