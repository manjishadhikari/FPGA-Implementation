...
HD_PWD='H:/Xilinxprojects/project_xor/project_xor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lut_xor_tb.vds -m64 -mode batch -messageDb vivado.pb -notrace -source lut_xor_tb.tcl
