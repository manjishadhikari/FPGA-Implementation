...
HD_PWD='H:/project_playlist/project_playlist.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log playlist.vdi -applog -m64 -messageDb vivado.pb -mode batch -source playlist.tcl -notrace
