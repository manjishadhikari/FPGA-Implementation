...
HD_PWD='H:/project_dft/project_dft.runs/microblaze_mcs_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_mcs_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source microblaze_mcs_0.tcl
