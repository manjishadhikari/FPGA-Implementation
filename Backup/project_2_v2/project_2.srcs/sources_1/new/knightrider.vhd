...
volumecontrol: volume port map(clk=>clk1,volcontrol=>volcontrol,data_in=>data,data_out=>vol_out);
pdm1: pdm port map(clk=>clk1,reset=>reset1,datain=>vol_out,dataout=>pdmout,error=>Error);
