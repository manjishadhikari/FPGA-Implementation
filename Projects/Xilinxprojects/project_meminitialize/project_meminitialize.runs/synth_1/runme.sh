...
HD_PWD='H:/Xilinxprojects/project_meminitialize/project_meminitialize.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memory_01.vds -m64 -mode batch -messageDb vivado.pb -notrace -source memory_01.tcl
