...
HD_PWD='H:/test/project_knightrider/project_knightrider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log knightrider.vds -m64 -mode batch -messageDb vivado.pb -notrace -source knightrider.tcl
